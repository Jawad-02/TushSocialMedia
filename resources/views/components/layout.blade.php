  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <img src="/icon.png" class="mr-2 icon" >
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">TUSH</a></h4>
        @auth
        <div class="flex-row my-3 my-md-0">
            ...
            <a class="btn btn-sm btns mr-2" href="/create-post">Create Post</a>
        ...
        <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
            @csrf
              ...
              <div class="col-md-auto">
                <button class="btn btns btn-sm">Sign In</button>
              </div>
            </div>
          </form>
        @endauth
    ...
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; 2024 <a href="/" class="text-muted">TorosBlogs</a>. All rights reserved.</p>
      </footer>
